...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        print(f"Insert layers: {self.insert_layers}")
    ...
    def forward(self, x, prompt=None):
        ...
        if prompt is None:
            ...
            for i in range(len(self.blocks)):
                if i < self.insert_layers:
                    prompt_token = prompt[:, i]
...
@register_model
def vit_tiny_patch16_224_fppl(pretrained=False, **kwargs):
    """ViT-Tiny (Vit-Ti/16)"""
...
@register_model
def vit_tiny_patch16_384_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch32_224_fppl(pretrained=False, **kwargs):
    """ViT-Small (ViT-S/32)"""
...
@register_model
def vit_small_patch32_384_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch16_224_fppl(pretrained=False, **kwargs):
    """ViT-Small (ViT-S/16)
...
@register_model
def vit_small_patch16_384_fppl(pretrained=False, **kwargs):
    """ViT-Small (ViT-S/16)
    NOTE I've replaced my previous 'small' model definition and weights with the small variant from the DeiT paper
    """
    model_kwargs = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, **kwargs)
...
@register_model
def vit_base_patch32_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch32_384_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_384_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch8_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_384_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch16_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch16_384_fppl(pretrained=False, **kwargs):
    """ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 384x384, source https://github.com/google-research/vision_transformer.
    """
    model_kwargs = dict(patch_size=16, embed_dim=1024, depth=24, num_heads=16, **kwargs)
...
@register_model
def vit_large_patch14_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_huge_patch14_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_giant_patch14_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_gigantic_patch14_224_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_tiny_patch16_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Tiny (Vit-Ti/16).
...
@register_model
def vit_small_patch32_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Small (ViT-S/16)
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_small_patch16_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Small (ViT-S/16)
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch32_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Base model (ViT-B/32) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch16_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_base_patch8_224_in21k_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_large_patch32_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Large model (ViT-L/32) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
...
@register_model
def vit_large_patch16_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Large model (ViT-L/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has valid 21k classifier head and no representation (pre-logits) layer
    """
...
@register_model
def vit_huge_patch14_224_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Huge model (ViT-H/14) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-21k weights @ 224x224, source https://github.com/google-research/vision_transformer.
    NOTE: this model has a representation layer but the 21k classifier head is zero'd out in original weights
    """
...
@register_model
def vit_base_patch16_224_sam_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch32_224_sam_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch16_224_dino_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_small_patch8_224_dino_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_dino_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch8_224_dino_fppl(pretrained=False, **kwargs):
...
@register_model
def vit_base_patch16_224_miil_in21k_fppl(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
...
@register_model
def vit_base_patch16_224_miil_fppl(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    Weights taken from: https://github.com/Alibaba-MIIL/ImageNet21K
    """
    model_kwargs = dict(
...
@register_model
def vit_base_patch32_plus_256_fppl(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/32+)"""
    model_kwargs = dict(
        patch_size=32, embed_dim=896, depth=12, num_heads=14, init_values=1e-5, **kwargs
    )
    model = _create_vision_transformer(
...
@register_model
def vit_base_patch16_plus_240_fppl(pretrained=False, **kwargs):
    """ViT-Base (ViT-B/16+)"""
    model_kwargs = dict(
        patch_size=16, embed_dim=896, depth=12, num_heads=14, init_values=1e-5, **kwargs
    )
    model = _create_vision_transformer(
...
@register_model
def vit_base_patch16_rpn_224_fppl(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_base_patch16_rpn_224", pretrained=pretrained, **model_kwargs
    )
    return model


@register_model
def vit_small_patch16_36x1_224_fppl(pretrained=False, **kwargs):
    """ViT-Base w/ LayerScale + 36 x 1 (36 block serial) config. Experimental, may remove.
    Based on `Three things everyone should know about Vision Transformers` - https://arxiv.org/abs/2203.09795
    Paper focuses on 24x2 + 48x1 for 'Small' width but those are extremely slow.
    """
    model_kwargs = dict(
        patch_size=16, embed_dim=384, depth=36, num_heads=6, init_values=1e-5, **kwargs
    )
    model = _create_vision_transformer(
...
@register_model
def vit_small_patch16_18x2_224_fppl(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer(
        "vit_small_patch16_18x2_224", pretrained=pretrained, **model_kwargs
    )
    return model


@register_model
def vit_base_patch16_18x2_224_fppl(pretrained=False, **kwargs):
